...
module.exports = L.TileLayer.Canvas.extend({
  ...
  featureAt: function(tileID, tilePoint) {
    if (!this._canvasIDToFeatures[tileID] || !this._tiles[tilePoint.x + ":" + tilePoint.y]) return null; // break out
